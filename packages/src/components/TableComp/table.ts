// table表格
export type VNodeChild = import("vue").VNodeChild;
export type Type = "selection" | "index" | "expand" | "image" | "date";
export type Size = "large" | "default" | "small";
export type Align = "center" | "left" | "right";
export type Command = string | number;
export type DateFormat = "YYYY-MM-DD" | "YYYY-MM-DD HH:mm:ss" | "YYYY-MM-DD HH:mm" | "YYYY-MM";
